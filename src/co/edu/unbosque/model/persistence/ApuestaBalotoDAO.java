...
/**
 * La clase ApuestaBalotoDAO implementa operaciones CRUD (Crear, Leer,
 * Actualizar y Eliminar) para gestionar una lista de apuestas del juego Baloto.
...
public class ApuestaBalotoDAO implements CRUDOperation {
	...
	private ArrayList<ApuestaBalotoDTO> listOfBets;
	final String SERIAL_FILENAME = "apuestaBaloto.dat";
	int index = 0;

	/**
	 * Constructor de la clase ApuestaBalotoDAO que inicializa la lista de apuestas.
	 */
	public ApuestaBalotoDAO() {
		listOfBets = new ArrayList<>();
		if (FileHandler.serializableOpenAndReadFile(SERIAL_FILENAME) != null) {
			Object temp = FileHandler.serializableOpenAndReadFile(SERIAL_FILENAME);
			ArrayList<ApuestaBalotoDTO> temp2 = (ArrayList<ApuestaBalotoDTO>) temp;
			listOfBets = temp2;
		} else {
			listOfBets = new ArrayList<>();
		}
	...
	public void create(String... args) {
		ApuestaBalotoDTO bet = new ApuestaBalotoDTO();
	...
	public void create(Object o) {
		listOfBets.add((ApuestaBalotoDTO) o);
		writeDataSerializable();
	}
	...
	public boolean update(int index, String... args) {
		if (index < 0 || index >= listOfBets.size()) {
			...
			if (!args[4].isBlank() || !args[4].isEmpty() || args[4] != null) {
				...
				listOfBets.get(index).setSixNumbers(numbers);
			}
		}
		writeDataSerializable();
		return true;
	...
	public boolean delete(Object o) {
		ApuestaBalotoDTO toDelete = (ApuestaBalotoDTO) o;
	 ...
	 */
	public ArrayList<ApuestaBalotoDTO> getListOfBets() {
		return listOfBets;
	}
	 ...
	 */
	public void setListOfBets(ArrayList<ApuestaBalotoDTO> listOfBets) {
